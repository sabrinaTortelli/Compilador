...
public class LParser implements LParserConstants {
    ...
    void consumeUntil(RecoverySet g,ParseException e, String met) throws ParseEOFException, ParseException
    {
        ...
        System.out.println(im(tok.kind));
        System.out.println("___________________");
        while (!eof)
        {
    ...
    public void setSintaticAnalysis(WindowER gui){
        sintaticAnalysis = new SintaticAnalysis(gui);
    }
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET).union(g),
      ...
      try {
        ...
        Description(g);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração do Programa");
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração da Descrição");
 ...
 RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        if (jj_2_1(2)) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração do Tipo Enumerado");
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_DOT);
      try {
        ...
        while (true) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração da Lista do Tipo Enumerado");
    ...
    try {
      try {
        ...
        while (true) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração da Lista de Identificadores");
 ...
 RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração de Constantes e Variáveis");
    ...
    try {
      try {
        ...
        ConstantAndVariablesInitiation(g);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Ordem de Constantes e Variáveis");
 ...
 RecoverySet f1 = First.AsVariables.union(g),
      ...
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Constantes e Variáveis");
consumeUntil(g, e, "constants and varibles");
      }
    } finally {
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Constantes");
 ...
 RecoverySet f1 = new RecoverySet(RESERVED_WORD_IS),
      ...
      try {
        ...
        while (true) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Lista de Constantes");
consumeUntil(g, e, "constant list");
      }
    } finally {
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Tipo de Contantes");
consumeUntil(g, e, "ConstTypeValueCombo");
      }
    } finally {
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Tipo e valor lógico");
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Variável");
  ...
  RecoverySet f1 = new RecoverySet(RESERVED_WORD_IS),
      ...
      try {
        ...
        while (true) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Lista de Variáveis");
 ...
 RecoverySet f1 = First.Index.union(g);
      try {
        ...
        while (true) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Lista de Identificadores de Variáveis");
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Índice");
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Tipos de Variáveis");
 ...
 RecoverySet f1 = new RecoverySet(RESERVED_WORD_AS),
      ...
      try {
        ...
        jj_consume_token(ESP_SYMBOL_DOT);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração de Comando de Atribuição");
...
RecoverySet f1 = First.ExpressionL.union(g);
      try {
        ...
        ExpressionL(g);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Expressão");
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Expressão L");
...
RecoverySet f1 = First.LowestPriority.union(g);
      try {
        ...
        LowestPriority(g);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Expressão Lógica ou Aritmética");
 ...
 RecoverySet f1 = First.LowestPriority.union(g);
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Baixa prioridade");
 ...
 RecoverySet f1 = First.MediumPriority.union(g);
      try {
        ...
        MediumPriority(g);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Segundo Termo");
 ...
 RecoverySet f1 = First.MediumPriority.union(g);
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Média Prioridade");
 ...
 RecoverySet f1 = First.HighestPriority.union(g);
      try {
        ...
        HighestPriority(g);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Primeiro termo");
 ...
 RecoverySet f1 = First.HighestPriority.union(g);
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Alta prioridade");
 ...
 RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_PARENTHESIS);
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Elemento");
 ...
 RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        ...
        jj_consume_token(ESP_SYMBOL_DOT);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração de Entrada de Dados");
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração de Saída de Dados");
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        ...
        jj_consume_token(ESP_SYMBOL_DOT);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Saída This");
    ...
    try {
      try {
        ...
        This(g);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Saída AllThis");
 ...
 RecoverySet f1 = First.OutPutConstants.union(g);
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Lista de Identificadores e/ou Constantes");
consumeUntil(g, e, "IdentifiersAndOrConstantsList");
      }
    } finally {
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_DOT),
      ...
      try {
        ...
        jj_consume_token(ESP_SYMBOL_DOT);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração de Comando de Seleção");
 ...
 RecoverySet f1 = First.EvaluateUntrue.union(g),
      ...
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Avaliação");
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        ...
        jj_consume_token(ESP_SYMBOL_R_BRACKET);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Avaliação verdadeira");
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        ...
        jj_consume_token(ESP_SYMBOL_R_BRACKET);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Avaliação falsa");
 ...
 RecoverySet f1 = First.Command.union(g);
      try {
        ...
        while (true) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Lista de Comandos");
    ...
    try {
      try {
        ...
        default:
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Comandos");
...
RecoverySet f1 = First.EvaluateRep.union(f2);
      try {
        ...
        jj_consume_token(ESP_SYMBOL_DOT);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Declaração de Comando de Repetição");
    ...
    try {
      try {
        if (jj_2_3(2)) {
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Avaliação de Condição de Repetição");
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        ...
        jj_consume_token(ESP_SYMBOL_R_BRACKET);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Avaliação de Condição de Repetição: condição satisfeita");
...
RecoverySet f1 = new RecoverySet(ESP_SYMBOL_R_BRACKET);
      try {
        ...
        jj_consume_token(ESP_SYMBOL_R_BRACKET);
          ...
          sintaticAnalysis.printNotRecognized(g, e, "Avaliação de Condição de Repetição: condição não satisfeita");
...
;
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x8,0x0,0x0,0x10,0x400,0x400,0x280,0x0,0x0,0x7800,0xc00000,0x0,0x0,0x0,0x0,0x7800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0c00000,0x80002,0x0,0x0,0xc0000000,0xc0000000,0x800000,0x400000,0xc00000,0x370000,0x370000,0x0,0xc0ff7fff,0xc0ff7fff,0x0,0xff7fff,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x2,0x2,0x0,0x0,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x0,0x2,0x0,0x3,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x7f,0x7f,0x0,0x0,};
   }
